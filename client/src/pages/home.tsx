      ...
      <div className="absolute top-4 right-4 z-10">
        <Dialog>
          ...
          <DialogContent className="sm:max-w-[425px]">
            <DialogHeader>
              <DialogTitle className="text-2xl font-bold text-deep-navy">Want to reach more readers?</DialogTitle>
              <DialogDescription className="text-deep-navy/80 pt-4">
                Partner with Purli to create clean versions of your books and tap into a growing market of readers who prefer content without explicit material.
            ...
            <Form {...authorForm}>
              <form
                onSubmit={authorForm.handleSubmit((data) => joinWaitlist.mutate(data))}
              ...
              >
                ...
                >
                  ...
                  {joinWaitlist.isPending ? "Sending..." : "Contact Us"}
                </Button>
              </form>
            </Form>
          </DialogContent>
      ...
      <div className="container mx-auto px-4 py-16 md:py-24">
        ...
        <Card className="max-w-md mx-auto bg-white border-soft-gray">
          <CardContent className="pt-6">
            ...
            <Form {...form}>
              <form
                onSubmit={form.handleSubmit((data) => joinWaitlist.mutate(data))}
                className="space-y-4"
              >
                <FormField
